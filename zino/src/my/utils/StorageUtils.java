...
public class StorageUtils {
	...
	public static StorageUtils Blog = new StorageUtils("blog");
	public static StorageUtils Image = new StorageUtils("img");
	public static StorageUtils DOC = new StorageUtils("doc");
